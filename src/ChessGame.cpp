...
ChessGame::ChessGame(ChessBoard* board, ChessTeam* blackTeam, ChessTeam* whiteTeam)
    : board(board), blackTeam(blackTeam), whiteTeam(whiteTeam) {
...
void ChessGame::renderBoard(SDL_Renderer* renderer, int xOffset, int yOffset, int fieldSize, int mouseX, int mouseY) {

    for (auto chess_field : board->board) {
        SDL_Rect fieldRect = {
            xOffset + chess_field.x * fieldSize,
            yOffset + chess_field.y * fieldSize,
            fieldSize,
            fieldSize
        };
        ...
        chess_field.draw(renderer, xOffset + chess_field.x * fieldSize, yOffset + chess_field.y * fieldSize, fieldSize, hovered, false);
    }
}

void ChessGame::renderText(
...
void ChessGame::renderTitleScreen(
    SDL_Renderer* renderer,
    TTF_Font* titleFont,
    TTF_Font* buttonFont,
    int width,
